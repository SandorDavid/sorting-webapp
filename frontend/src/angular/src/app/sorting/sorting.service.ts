...
export class SortingService {
    ...
    getAlgorithmNames$(): Observable<String[]> {
        return this.http.get<String[]>(environment.APIURL + '/sorting/get-algorithm-names');
    }

    getSortedList$(sortingReq: SortingRequest): Observable<SortingResponse> {
        return this.http.post<SortingResponse>(environment.APIURL + '/sorting/sort', sortingReq);
    }
}
